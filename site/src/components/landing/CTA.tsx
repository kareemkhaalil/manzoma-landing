      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-brand-navy px-8 py-4 rounded-full text-sm font-[900] hover:bg-brand-bg transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 inline-flex items-center justify-center gap-2">
              ابدأ إنشاء حسابك الآن
              <ChevronLeft className="w-4 h-4 opacity-50" />
            </button>
            <button className="border border-white/20 text-white/80 px-8 py-4 rounded-full text-sm font-[800] hover:bg-white/10 transition-all inline-flex items-center justify-center gap-2">
              شاهد عرض توضيحي
            </button>
          </div>
        </motion.div>
