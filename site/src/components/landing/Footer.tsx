        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-9 h-9 rounded-xl bg-brand-bg border border-brand-border flex items-center justify-center text-brand-muted hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-all duration-300">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.56c-.88.39-1.83.65-2.83.77a4.93 4.93 0 002.17-2.72 9.86 9.86 0 01-3.13 1.2 4.92 4.92 0 00-8.38 4.48A13.94 13.94 0 011.67 3.15a4.93 4.93 0 001.52 6.57 4.9 4.9 0 01-2.23-.62v.06a4.93 4.93 0 003.95 4.83 4.93 4.93 0 01-2.22.08 4.93 4.93 0 004.6 3.42A9.87 9.87 0 010 19.54a13.93 13.93 0 007.55 2.21c9.06 0 14.01-7.5 14.01-14.01 0-.21 0-.42-.01-.63A10 10 0 0024 4.56z"/></svg>
              </a>
              <a href="#" className="w-9 h-9 rounded-xl bg-brand-bg border border-brand-border flex items-center justify-center text-brand-muted hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-all duration-300">
            ...
            <div key={idx}>
              ...
              <ul className="space-y-3">
                {section.links.map((link) => {
                  // Check if link is internal page link
                  const isPageLink = link.url.startsWith("/page/");
                  return (
                    <li key={link.id}>
                      {isPageLink ? (
                        <Link
