...
import { ChevronLeft, ArrowLeft, ShieldCheck, Zap, Headset } from "lucide-react";
    ...
    <section className="relative pt-36 pb-20 md:pt-44 md:pb-32 flex flex-col items-center justify-center overflow-hidden bg-brand-bg min-h-[90vh]">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
        ...
        >
          ...
          <a href="https://app.manzoma.online" target="_blank" rel="noopener noreferrer" className="btn-outline px-7 py-3.5 text-base flex items-center justify-center gap-2">
            تسجيل الدخول
          </a>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mt-8 text-slate-500 font-bold text-xs sm:text-sm"
        >
          <div className="flex items-center gap-1.5">
            <ShieldCheck className="w-4 h-4 text-brand-emerald" />
            لا يطلب بطاقة ائتمان
          </div>
          ...
          <div className="hidden sm:block w-1 h-1 rounded-full bg-slate-300" />
          <div className="flex items-center gap-1.5">
            <Headset className="w-4 h-4 text-brand-primary" />
            دعم فني 24/7
          </div>
        </motion.div>
