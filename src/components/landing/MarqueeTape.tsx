...
export default function MarqueeTape() {
  const row1Items = [
    "نظام كاشير هجين يعمل بالكامل أوفلاين",
    "فواتير إلكترونية فورية مرسلة عبر الواتساب",
    "تأمين الخزينة وحمايتها عبر نظام العد الأعمى",
    "توليد تلقائي لمصفوفة المقاسات والألوان بضغطة زر",
    "مزامنة سحابية لحظية وآمنة لجميع الفروع",
    "إدارة وتتبع استهلاك الخامات وقوائم المواد BOM",
    "تقارير يومية وجرد سريع بالباركود لمنع العجز"
  ];

  const row2Items = [
    "أسرع وأسهل لوحة تحكم لإدارة المبيعات والتجزئة",
    "إغلاق الورديات وترحيل الحسابات بدقة متناهية",
    "دعم كامل لأجهزة الباركود والموازين الإلكترونية",
    "تنبيهات ذكية للنواقص وكميات المخزون الحرجة",
    "متوافق بالكامل مع معايير مصلحة الضرائب المصرية",
    "تقارير الأرباح الصافية وتحليلات الأداء اللحظية",
    "إدارة الموظفين والصلاحيات المتعددة للورديات"
  ];
